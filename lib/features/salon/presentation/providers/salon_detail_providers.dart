...
import 'package:glamgo/features/salon/domain/repositories/salon_detail_repository.dart';
...
final salonDetailProvider = FutureProvider.family
    .autoDispose<SalonDetailModel, String>((ref, id) async {
...
final selectedServicesProvider =
    StateNotifierProvider.autoDispose<SelectedServicesNotifier, Set<String>>((
      ref,
    ) {
