...
import 'package:glamgo/features/salon/domain/repositories/booking_slot_repository.dart';
...
final calendarDaysStreamProvider =
    FutureProvider.autoDispose<List<CalendarDayModel>>((ref) async {
...
final timeSlotsStreamProvider = FutureProvider.family
    .autoDispose<List<TimeSlotModel>, DateTime>((ref, date) async {
      return ref.watch(bookingRepositoryProvider).getTimeSlotsForDay(date);
    });

final selectedTimeSlotProvider = StateProvider.autoDispose<TimeSlotModel?>(
  (ref) => null,
);
